# Lesson 13: Section A — Bars 4-7 — Bars 4-7
**Phase:** Building
**Prerequisites:** Lessons 11, 12
**Estimated time:** 25 minutes
**You'll need:** Guitar, metronome, tuner

## Goal
Play bars 4-7 cleanly with pre_bend, bend_release, pull_off at 40% tempo (51 bpm) with clean execution and musical phrasing.
...
### Step 1: Learn the Notes — Bars 4-5
Open your tab and read through bars 4-5.
...
- **Repeat:** Play through bars 4-5 at least 5 times slowly.

### Step 2: Learn the Notes — Bars 6-7
Continue to bars 6-7.
...
Go back through bars 4-7 and focus on the techniques: pre_bend, bend_release, pull_off.
...
Think vocally — if you were singing bars 4-7, how would it sound?
...
- **Do this:** Play bars 4-7 with metronome. If clean, increase by 5 bpm. If it falls apart, drop back 10 bpm.
...
- **Do this:** At 40% tempo, play bars 4-7 three times in a row with no mistakes.
